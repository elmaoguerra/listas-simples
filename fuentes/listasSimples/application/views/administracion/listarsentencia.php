...
<div id="tablewrapper"> 
        ...
        <table cellpadding="0" cellspacing="0" border="0" id="table" class="tinytable"> 
            <thead> 
                <tr> 
                         <th><h3>id</h3></th>
     <th><h3>instruccion</h3></th>
     <th><h3>ejercicio_id</h3></th>
    ...
    <th width="50" align="center" class="nosort"><h3>Eliminar</h3></th>
     ...
     <td align="center"><?php echo $row->instruccion; ?></td>
     <td align="center"><?php echo $row->ejercicio_id; ?></td>
     <td width="50" align="center"><a href="<?php echo base_url();?>index.php/adminsentencia/actualizar/<?php echo $row->id;?>"><img src="<?php echo base_url();?>images/editar.png" width="21" height="21" style="border: none;" /></a></td>
    <td align="center"><a href="<?php echo base_url();?>index.php/adminsentencia/eliminar/<?php echo $row->id;?>"><img src="<?php echo base_url();?>images/delete.png" width="21" height="21" style="border: none;" /></a></td>
