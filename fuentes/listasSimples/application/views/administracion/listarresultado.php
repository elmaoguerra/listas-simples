...
<div id="tablewrapper"> 
    ...
    <th width="50" align="center" class="nosort"><h3>Eliminar</h3></th>
     ...
     <td width="50" align="center"><a href="<?php echo base_url();?>index.php/adminresultado/actualizar/<?php echo $row->ejercicio_id;?>"><img src="<?php echo base_url();?>images/editar.png" width="21" height="21" style="border: none;" /></a></td>
    <td align="center"><a href="<?php echo base_url();?>index.php/adminresultado/eliminar/<?php echo $row->ejercicio_id;?>"><img src="<?php echo base_url();?>images/delete.png" width="21" height="21" style="border: none;" /></a></td>
